...
export const MONKSPELLS = {
    ...
    },
    {
        ...
        runFunc: function (state) {
            ...
            const CelestialBuff = state.activeBuffs.filter(function (buff) {return buff.name === "Celestial Active"}).length > 0;
            if (CelestialBuff){
            ...
            /*
            // TODO: Implement Chiji reduced mana cost
    ...
    },
    {
        ...
        type: "function",
        function: function (state) {
            state.activeBuffs.push({name: "Celestial Active", buffType: "special", stacks: 1, expiration: 25})
        }
    }],
    "Invoke Chiji": [{ // Invoke Chi-Ji, the Red Crane
        ...
        function: function (state) {
            // Enveloping Breath activator / Celestial active flag
            state.activeBuffs.push({name: "Celestial Active", buffType: "special", stacks: 1, expiration: 25})
            state.activeBuffs.push({name: "Chiji Active", buffType: "special", stacks: 1, expiration: 25})
        }
    }]
}
