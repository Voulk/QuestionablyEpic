...
describe("Test Sequences", () => {
    ...
    test("Legendaries & Soulbinds", () => {
        ...
        const venthprehpm = Math.round((covenants["VenthPre"][0].hpm + covenants["VenthPre"][1].hpm*2/14 + covenants["VenthPre"][2].hpm*3/14 + (getFOHealing(player) + getLongCloneHealing(player))/2000*4/14)*100)/100
        const venthprehps = Math.round((covenants["VenthPre"][0].hps + covenants["VenthPre"][1].hps*2/14 + covenants["VenthPre"][2].hps*3/14 + (getFOHealing(player) + getLongCloneHealing(player))/24*4/480)*100)/100
        const venthpredps = Math.round((covenants["VenthPre"][0].dps + covenants["VenthPre"][1].dps*2/14 + covenants["VenthPre"][2].dps*3/14)*100)/100
        const venthpreatotmhpm = Math.round((covenants["VenthPre"][3].hpm + covenants["VenthPre"][4].hpm*2/14 + covenants["VenthPre"][5].hpm*3/14 + (getFOHealing(player))/2000*3/14)*100)/100
        const venthpreatotmhps = Math.round((covenants["VenthPre"][3].hps + covenants["VenthPre"][4].hps*2/14 + covenants["VenthPre"][5].hps*3/14 + (getFOHealing(player))/24*3/480)*100)/100
        const venthpreatotmdps = Math.round((covenants["VenthPre"][3].dps + covenants["VenthPre"][4].dps*2/14 + covenants["VenthPre"][5].dps*3/14)*100)/100
        ...
        const nfprehpm = Math.round((covenants["NFPre"][0].hpm + covenants["NFPre"][1].hpm*2/14 + covenants["NFPre"][2].hpm*3/14)*100)/100
        const nfprehps = Math.round((covenants["NFPre"][0].hps + covenants["NFPre"][1].hps*2/14 + covenants["NFPre"][2].hps*3/14)*100)/100
        const nfpredps = Math.round((covenants["NFPre"][0].dps + covenants["NFPre"][1].dps*2/14 + covenants["NFPre"][2].dps*3/14)*100)/100
        ...
        const nlprehpm = Math.round((covenants["NLPre"][0].hpm*5/14 + covenants["NLPre"][1].hpm*9/14 + covenants["NLPre"][2].hpm*2/14 + covenants["NLPre"][3].hpm*3/14)*100)/100
        const nlprehps = Math.round((covenants["NLPre"][0].hps*5/14 + covenants["NLPre"][1].hps*9/14 + covenants["NLPre"][2].hps*2/14 + covenants["NLPre"][3].hps*3/14)*100)/100
        const nlpredps = Math.round((covenants["NLPre"][0].dps*5/14 + covenants["NLPre"][1].dps*9/14 + covenants["NLPre"][2].dps*2/14 + covenants["NLPre"][3].dps*3/14)*100)/100
        ...
        const kyrian1lhpm = Math.round((covenants["Kyrian1L"][0].hpm*10/14 + covenants["Kyrian1L"][1].hpm*2/14 + covenants["Kyrian1L"][2].hpm*3/14 + covenants["Kyrian1L"][3].hpm*4/14)*100)/100
        const kyrian1lhps = Math.round((covenants["Kyrian1L"][0].hps*10/14 + covenants["Kyrian1L"][1].hps*2/14 + covenants["Kyrian1L"][2].hps*3/14 + covenants["Kyrian1L"][3].hps*4/14)*100)/100
        const kyrian1ldps = Math.round((covenants["Kyrian1L"][0].dps*10/14 + covenants["Kyrian1L"][1].dps*2/14 + covenants["Kyrian1L"][2].dps*3/14 + covenants["Kyrian1L"][3].dps*4/14)*100)/100
        ...
        const venth1lhps = Math.round((covenants["Venth1L"][0].hps + covenants["Venth1L"][1].hps*2/14 + covenants["Venth1L"][2].hps*3/14 + (venth4pcfobonuspercast + getFOHealing(player4pc) + getLongCloneHealing(player4pc))*4/480)*100)/100
        ...
        const nf1lhpm = Math.round((covenants["NF1L"][0].hpm + covenants["NF1L"][1].hpm*2/14 + covenants["NF1L"][2].hpm*3/14)*100)/100
        const nf1lhps = Math.round((covenants["NF1L"][0].hps + covenants["NF1L"][1].hps*2/14 + covenants["NF1L"][2].hps*3/14)*100)/100
        const nf1ldps = Math.round((covenants["NF1L"][0].dps + covenants["NF1L"][1].dps*2/14 + covenants["NF1L"][2].dps*3/14)*100)/100
        ...
        const nl1lhpm = Math.round((covenants["NL1L"][4].hpm*5/14 + covenants["NL1L"][5].hpm*9/14 + covenants["NL1L"][6].hpm*2/14 + covenants["NL1L"][7].hpm*3/14)*100)/100
        const nl1lhps = Math.round((covenants["NL1L"][4].hps*5/14 + covenants["NL1L"][5].hps*9/14 + covenants["NL1L"][6].hps*2/14 + covenants["NL1L"][7].hps*3/14)*100)/100
        const nl1ldps = Math.round((covenants["NL1L"][4].dps*5/14 + covenants["NL1L"][5].dps*9/14 + covenants["NL1L"][6].dps*2/14 + covenants["NL1L"][7].dps*3/14)*100)/100
        ...
        const kyrianhpm = Math.round((covenants["Kyrian"][0].hpm*10/14 + covenants["Kyrian"][1].hpm*2/14 + covenants["Kyrian"][2].hpm*3/14 + covenants["Kyrian"][3].hpm*4/14)*100)/100
        const kyrianhps = Math.round((covenants["Kyrian"][0].hps*10/14 + covenants["Kyrian"][1].hps*2/14 + covenants["Kyrian"][2].hps*3/14 + covenants["Kyrian"][3].hps*4/14)*100)/100
        const kyriandps = Math.round((covenants["Kyrian"][0].dps*10/14 + covenants["Kyrian"][1].dps*2/14 + covenants["Kyrian"][2].dps*3/14 + covenants["Kyrian"][3].dps*4/14)*100)/100
        ...
        const venthhps = Math.round((covenants["Venth"][0].hps + covenants["Venth"][1].hps*2/14 + covenants["Venth"][2].hps*3/14 + (venth4pcfobonuspercast + getFOHealing(player4pc) + getLongCloneHealing(player4pc))*4/480)*100)/100
        ...
        const nlhpm = Math.round((covenants["NL"][4].hpm*5/14 + covenants["NL"][5].hpm*9/14 + covenants["NL"][6].hpm*2/14 + covenants["NL"][7].hpm*3/14)*100)/100
        const nlhps = Math.round((covenants["NL"][4].hps*5/14 + covenants["NL"][5].hps*9/14 + covenants["NL"][6].hps*2/14 + covenants["NL"][7].hps*3/14)*100)/100
        const nldps = Math.round((covenants["NL"][4].dps*5/14 + covenants["NL"][5].dps*9/14 + covenants["NL"][6].dps*2/14 + covenants["NL"][7].dps*3/14)*100)/100
