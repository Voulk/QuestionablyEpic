...
describe("Test Sequences", () => {
    ...
    const kyrianWoOSequence =  ["Tiger Palm", "Tiger Palm", "Essence Font", "Weapons of Order", "Essence Font", "Tiger Palm", "Renewing Mist", "Refreshing Jade Wind", "Thunder Focus Tea", "Rising Sun Kick", "Chi Burst", "Rising Sun Kick", "Blackout Kick", "Tiger Palm", "Refreshing Jade Wind", "Essence Font", "Blackout Kick", "Rising Sun Kick", "Tiger Palm", "Tiger Palm", "Renewing Mist", "Refreshing Jade Wind", "Blackout Kick", "Rising Sun Kick"];
    ...
    test("Legendaries & Soulbinds", () => {
        ...
        covenants["KyrianPre"].push(runCastSequence(YulonBase, pretierStats, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        covenants["KyrianPre"].push(runCastSequence(RevivalBase, pretierStats, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        covenants["KyrianPre"].push(runCastSequence(kyrianWoOSequence, pretierStats, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        ...
        // 4pc, 2 legendary
        // Kyrian
        covenants["Kyrian"].push(runCastSequence(baseSequence, activeStats3, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        covenants["Kyrian"].push(runCastSequence(YulonBase, activeStats3, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        covenants["Kyrian"].push(runCastSequence(RevivalBase, activeStats3, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        covenants["Kyrian"].push(runCastSequence(kyrianWoOSequence, activeStats3, {"DefaultLoadout": true, "covenant": "Kyrian", "legendaries": ["Ancient Teachings of the Monastery"], "misc": []}, {}, 14))
        ...
        "Venth Per-FO: " + (getFOHealing(player) + getLongCloneHealing(player) + venth4pcfobonuspercast) + " (+HPS: " + (venth4pcfobonuspercast + getFOHealing(player) + getLongCloneHealing(player))/24);
        ...
        "Yulon Venth: " +  covenants["Venth"][1].sequenceLength + "\n" +
        "Yulon NF: " +  covenants["Night Fae"][1].sequenceLength + "\n" +
        "Yulon NL: " +  covenants["NL"][6].sequenceLength
        );
    })
