...
describe("Test Sequences", () => {
    ...
    const NFsequencePreTier = ["Essence Font", "Rising Sun Kick", "Faeline Stomp", "Tiger Palm", "Tiger Palm", "Tiger Palm", "Renewing Mist", "Renewing Mist", "Refreshing Jade Wind", "Thunder Focus Tea", "Rising Sun Kick", "Faeline Stomp", "Rising Sun Kick", "Blackout Kick", "Chi Burst", "Refreshing Jade Wind", "Blackout Kick", "Essence Font", "Rising Sun Kick", "Tiger Palm", "Tiger Palm", "Tiger Palm", "Blackout Kick", "Refreshing Jade Wind", "Faeline Stomp", "Renewing Mist", "Rising Sun Kick", "Tiger Palm", "Tiger Palm", "Tiger Palm", "Blackout Kick"];
    
    // NF 12.42% haste, NL 22.7% haste
    const NLsequence = ["Tiger Palm", "Tiger Palm", "Refreshing Jade Wind", "Essence Font", "Tiger Palm", "Renewing Mist", "Renewing Mist", "Refreshing Jade Wind", "Bonedust Brew", "Thunder Focus Tea", "Rising Sun Kick", "Chi Burst", "Rising Sun Kick", "Blackout Kick", "Refreshing Jade Wind", "Essence Font", "Blackout Kick", "Rising Sun Kick", "Tiger Palm", "Tiger Palm", "Tiger Palm", "Blackout Kick", "Renewing Mist", "Refreshing Jade Wind"];
    const baseSequence =  ["Tiger Palm", "Tiger Palm", "Refreshing Jade Wind", "Essence Font", "Tiger Palm", "Renewing Mist", "Renewing Mist", "Refreshing Jade Wind", "Thunder Focus Tea", "Rising Sun Kick", "Chi Burst", "Rising Sun Kick", "Blackout Kick", "Tiger Palm", "Refreshing Jade Wind", "Essence Font", "Blackout Kick", "Rising Sun Kick", "Tiger Palm", "Tiger Palm", "Tiger Palm", "Blackout Kick", "Renewing Mist", "Refreshing Jade Wind"];
    ...
    const YulonVenth = ["Essence Font", "Invoke Yulon", "Mana Tea", "Enveloping Mist", "Enveloping Mist", "Thunder Focus Tea", "Rising Sun Kick", "Enveloping Mist", "Rising Sun Kick", "Enveloping Mist", "Enveloping Mist", "Enveloping Mist", "Enveloping Mist", "Chi Burst" ];
    ...
    test("Legendaries & Soulbinds", () => {
        ...
        "HPS over 8m fight: " + Math.round((covenants["NFPre"][0].totalHealing/30*14 + covenants["NFPre"][1].totalHealing/23*2 + covenants["NFPre"][2].totalHealing/4*3)/19*0.98*100)/100 + " - assuming 2 yulon, 3 revival");
        ...
        "HPS over 8m fight: " + Math.round(token * teatime * ((covenants["Venth"][0].totalHealing/30*14 + covenants["Venth"][1].totalHealing/21*2 + covenants["Venth"][2].totalHealing/3*3)/19 + (getFOHealing(player4pc) * 4 + getLongCloneHealing(player4pc) * 4)/480 + venth4pcfobonuspercast * 4 / 480)*100)/100 + " - assuming 2 yulon, 3 revival");
        ...
        "HPS over 8m fight: " + Math.round((covenants["Night Fae"][0].totalHealing/30*14 + covenants["Night Fae"][1].totalHealing/21.5*2 + covenants["Night Fae"][2].totalHealing/4*3)/19*100)/100 + " - assuming 2 yulon, 3 revival");
        // Haste bonus affects NF the most, sequence is much quicker - needed to make a longer sequence to accurately collect HPM
        ...
        "HPS over 8m fight: " + Math.round((covenants["NL"][4].totalHealing/30*5 + covenants["NL"][5].totalHealing*1.15/30*9 + covenants["NL"][6].totalHealing/21*2 + covenants["NL"][7].totalHealing/4*3)/19*100)/100 + " - assuming 2 yulon, 3 revival (using bdb for yulon + revival)");
