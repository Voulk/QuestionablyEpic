...
describe("Test Sequences", () => {
    ...
    test("Legendaries & Soulbinds", () => {
        ...
        console.log("Base Balanced Stats: " + covenants["Base"][0].totalHealing + " (HPM: " + covenants["Base"][0].hpm + "). Damage: " + covenants["Base"][0].totalDamage);
        ...
        console.log("NF Crit/Vers: " + covenants["Night Fae"][0].totalHealing + " (HPM: " + covenants["Night Fae"][0].hpm + "). Damage: " + covenants["Night Fae"][0].totalDamage);
        console.log("NF Crit/Haste: " + covenants["Night Fae"][1].totalHealing + " (HPM: " + covenants["Night Fae"][1].hpm + "). Damage: " + covenants["Night Fae"][1].totalDamage);
        console.log("NF Balanced: " + covenants["Night Fae"][2].totalHealing + " (HPM: " + covenants["Night Fae"][2].hpm + "). Damage: " + covenants["Night Fae"][2].totalDamage);
        ...
        console.log("NL Crit/Vers: " + (covenants["NL"][0].totalHealing + covenants["NL"][1].totalHealing*1.15)/2 + " (HPM: " + (covenants["NL"][0].hpm + covenants["NL"][1].hpm*1.15)/2 + "). Damage: " + (covenants["NL"][0].totalDamage+covenants["NL"][1].totalDamage*1.15)/2);
        console.log("NL Crit/Haste: " + (covenants["NL"][2].totalHealing + covenants["NL"][3].totalHealing*1.15)/2 + " (HPM: " + (covenants["NL"][2].hpm + covenants["NL"][3].hpm*1.15)/2 + "). Damage: " + (covenants["NL"][2].totalDamage+covenants["NL"][3].totalDamage*1.15)/2);
        console.log("NL Balanced: " + (covenants["NL"][4].totalHealing + covenants["NL"][5].totalHealing*1.15)/2 + " (HPM: " + (covenants["NL"][4].hpm + covenants["NL"][5].hpm*1.15)/2 + "). Damage: " + (covenants["NL"][4].totalDamage+covenants["NL"][5].totalDamage*1.15)/2);
