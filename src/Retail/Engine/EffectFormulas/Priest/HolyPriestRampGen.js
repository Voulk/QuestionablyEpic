...
export const buildHolyPriestAPLData = (stats, talents) => {

}



export const buildHolyPriestChartData = (activeStats) => {
    //
    let results = [];
    ...
    Object.keys(talents).forEach(talentName => {
        if (talents[talentName].heroTree === "Oracle") talents[talentName].points = 1;
    })
    const sequences = [
        /*
