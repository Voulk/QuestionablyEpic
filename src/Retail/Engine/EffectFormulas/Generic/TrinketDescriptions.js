...
const echoingTyrstone = (data, itemLevel, player, additionalData) => {
    ...
    return {
        ...
        description:
          "Nerfed. Now splits healing among all targets although the haste portion is still uncapped. A lot of the value now comes from this haste portion so don't expect it to do mega numbers on your meters anymore. More information to come.",
      };
}
