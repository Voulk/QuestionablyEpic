    ...
    case "Raging Vesper Vortex":
      legendaryDetails = {
        en: {
          ...
          slot: "Feet, Legs (recommended)",
          desc: "When 3 charges of Vesper Totem are consumed, Vesper Totem will radiate a 15 yd burst of (300% of Spell power) Arcane damage and (110% of Spell power) healing.",
          droploc: "Kyrian Renown 48",
          covenant: "Kyrian",
        },
        de: {
    ...
    case "Seeds of Rampant Growth":
      legendaryDetails = {
        en: {
          ...
          slot: "Head, Hands",
          desc: "Each pulse of Fae Transfusion's damage effect reduces the cooldown of Healing Tide Totem by 5.0 sec and increases your critical strike chance by 4% for 15 sec.",
          droploc: "Night Fae Renown 48",
          covenant: "Night Fae",
        },
        de: {
    ...
    case "Splintered Elements":
      legendaryDetails = {
        en: {
          ...
          slot: "Neck, Waist",
          desc: "Each additional Healing Wave generated by Primordial Wave increases your Haste by 10% for 12 sec.",
          droploc: "Necrolord Renown 48",
          covenant: "Necrolord",
        },
        de: {
