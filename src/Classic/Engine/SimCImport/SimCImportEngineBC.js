...
function processItem(line, player, contentType, type) {
      ...
      itemID === 69882) 
  {
    ...
    else if ([193, 214, 231, 263, 269, 282, 286].includes(suffix)) itemID = parseInt(itemID.toString() + "0") // Undertow
    else if ([188, 194, 215, 232, 264, 270, 283, 287].includes(suffix)) itemID = parseInt(itemID.toString() + "3") // Wavecrest
