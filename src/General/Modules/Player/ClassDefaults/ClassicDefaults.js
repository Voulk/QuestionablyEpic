...
export function initializeHPriestSet() {
  const testSettings = {spec: "Holy Priest Classic", masteryEfficiency: 0.7, includeOverheal: "Yes", reporting: true, t31_2: false, seqLength: 100, alwaysMastery: true};
  ...
  const castProfile = [
    ...
    {spell: "Circle of Healing", cpm: 7},
    {spell: "Holy Word: Sanctuary", cpm: 10, hastedCPM: true},
    {spell: "Holy Word: Serenity", cpm: 5, hastedCPM: false},
