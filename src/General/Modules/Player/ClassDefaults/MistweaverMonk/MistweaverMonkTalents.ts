...
"Fast Feet": {id: 388809, values: [70.0, 10.0],  points: 0, maxPoints: 1, icon: "ability_monk_risingsunkick", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    buffSpellPerc(spellDB["Rising Sun Kick"], talentValues[0])
    buffSpellPerc(spellDB["Spinning Crane Kick"], talentValues[1])
}},

/* Increases all healing taken by X%. */
"Grace of the Crane": {id: 388811, values: [6.0],  points: 0, maxPoints: 1, icon: "monk_ability_cherrymanatea", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Vivacious Vivification": {id: 388812, values: [15.0],  points: 0, maxPoints: 1, icon: "ability_monk_vivify", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* After casting Enveloping Mist, your next $?s399491[Sheilun's Gift][Vivify] becomes instant cast.   */
"Serene Surge": {id: 1266734, values: [15.0],  points: 0, maxPoints: 1, icon: "ability_monk_surgingmist", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* While no enemies are within X yds, you heal for $1266720s1 every $t1 sec. */
"Silent Sanctuary": {id: 1266719, values: [15.0],  points: 0, maxPoints: 1, icon: "spell_monk_zenpilgrimage", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},


/* You heal for X% of all magical damage taken. */
"Chi Warding": {id: 1277444, values: [3.0],  points: 0, maxPoints: 1, icon: "inv_belt__inv_leather_raidmonkmythic_s_01", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Chi Wave": {id: 450391, values: [0.0, -50.0],  points: 0, maxPoints: 1, icon: "ability_monk_chiwave", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Improved Touch of Death": {id: 322113, values: [15.0, 35.0],  points: 0, maxPoints: 1, icon: "ability_monk_touchofdeath", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Yu'lon's Grace": {id: 414131, values: [10.0, 10.0],  points: 0, maxPoints: 1, icon: "ability_monk_dragonkick", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Reduces the cooldown of Ring of Peace by ${X/-1000} sec and Song of Chi-Ji's cast time is reduced by ${Y/-1000}.1 sec. */
"Peace and Prosperity": {id: 450448, values: [-5000.0, -500.0],  points: 0, maxPoints: 1, icon: "inv_inscription_deck_redcrane", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},


/* Your healing is increased by up to X%, based on the current health of your target. Lower health targets are healed for more. */
"Save Them All": {id: 389579, values: [10.0],  points: 0, maxPoints: 1, icon: "inv_weapon_hand_22", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},


/* Vivify and Sheilun's Gift critical strike chances are increased by X% on yourself. */
"Vital Clarity": {id: 1266748, values: [15.0],  points: 0, maxPoints: 1, icon: "ability_monk_souldance", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: 
number) {
...
"Jade Infusion": {id: 1242910, values: [1.0],  points: 0, maxPoints: 1, icon: "ability_monk_summonserpentstatue", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Ironshell Brew": {id: 388814, values: [10.0, -10.0, -10.0, 10.0],  points: 0, maxPoints: 1, icon: "ability_monk_fortifyingale_new", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Fortifying Brew cooldown reduced by ${X/-1000} sec. */
"Expeditious Fortification": {id: 388813, values: [-30000.0],  points: 0, maxPoints: 1, icon: "ability_monk_fortifyingale_new", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},


/* While your Celestial is active, you cannot be slowed below Y% normal movement speed. */
"Celestial Determination": {id: 450638, values: [0.0, 90.0],  points: 0, maxPoints: 1, icon: "ability_monk_essencefont", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Chi Transfer": {id: 1272452, values: [60.0],  points: 0, maxPoints: 1, icon: "ability_monk_zenmeditation", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Fatal Touch": {id: 394123, values: [-90000.0],  points: 0, maxPoints: 1, icon: "ability_monk_touchofdeath", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Misty Coalescence": {id: 1268817, values: [300.0, 20.0],  points: 0, maxPoints: 1, icon: "inv_ability_monk_renewingmists_active", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Invigorating Mists": {id: 274586, values: [5.0, 500.0],  points: 0, maxPoints: 1, icon: "ability_monk_vivify", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Healing Elixir": {id: 122280, values: [40.0, 1.0, 2.0],  points: 0, maxPoints: 1, icon: "ability_monk_jasmineforcetea", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* The absorb amount of Life Cocoon is increased by X%. */
"Calming Coalescence": {id: 388218, values: [80.0],  points: 0, maxPoints: 1, icon: "ability_monk_healthsphere", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, 
points: number) {

}},

/* Life Cocoon grants up to X stacks of Mana Tea and applies Y stacks of Healing Elixir to its target. */
"Refreshment": {id: 467270, values: [5.0, 2.0],  points: 0, maxPoints: 1, icon: "inv_misc_gem_pearl_06", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: 
number) {
...
"Energizing Brew": {id: 422031, values: [-50.0, 20.0, -50.0],  points: 0, maxPoints: 1, icon: "ui_profession_herbalism", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Lifecycles": {id: 197915, values: [1.0, 20.0, 20.0],  points: 0, maxPoints: 1, icon: "ability_monk_souldance", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Zen Pulse": {id: 446326, values: [6.0, 30.0],  points: 0, maxPoints: 1, icon: "ability_monk_forcesphere", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Overflowing Mists": {id: 388511, values: [2.0],  points: 0, maxPoints: 1, icon: "inv_legion_faction_dreamweavers", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* After you fully consume Thunder Focus Tea, your next Vivify triggers Zen Pulse. */
"Deep Clarity": {id: 446345, values: [2.0],  points: 0, maxPoints: 1, icon: "ability_monk_zenmeditation", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Rising Sun Kick and Enveloping Mist apply Renewing Mist for X seconds to an ally within $r yds. */
"Rapid Diffusion": {id: 388847, values: [6.0],  points: 0, maxPoints: 2, icon: "ability_monk_chiswirl", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Yu'lon's Whisper": {id: 388038, values: [5.0],  points: 0, maxPoints: 1, icon: "ability_monk_chiexplosion", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Celestial Harmony": {id: 343655, values: [4.0, 10.0, 5.0, 4.0],  points: 0, maxPoints: 1, icon: "ability_monk_jadeserpentbreath", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Dancing Mists": {id: 388701, values: [8.0],  points: 0, maxPoints: 1, icon: "ability_monk_serenity", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Jade Empowerment": {id: 467316, values: [4.0, 300.0, 5.0, 25.0],  points: 0, maxPoints: 1, icon: "ability_monk_cracklingjadelightning", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
points: number) {
    ...
    slice.secondaries.push("mastery");
    slice.statMods.masteryMult += talentValues[0] / 100;

}},

/* Thunder Focus Tea now empowers your next ${$m1+1} spells. */
"Focused Thunder": {id: 197895, values: [1.0, 1.0],  points: 0, maxPoints: 1, icon: "spell_monk_nimblebrew", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Secret Infusion": {id: 388491, values: [4.0, 1.25],  points: 0, maxPoints: 2, icon: "ability_monk_chibrew", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Peaceful Mending": {id: 388593, values: [40.0],  points: 0, maxPoints: 1, icon: "pandarenracial_innerpeace", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Increases Sheilun's Gift cloud of mist generation to every ${-X/1000} sec.  */
"Veil of Pride": {id: 400053, values: [-4000.0, 4.0, 10.0],  points: 0, maxPoints: 1, icon: "ability_monk_vivify", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Consuming Mana Tea generates X $Lcloud of mist:clouds of mist;. */
"Tranquil Tea": {id: 1270621, values: [1.0],  points: 0, maxPoints: 1, icon: "inv_misc_pearlmilktea", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Emperor's Elixir": {id: 1268807, values: [0.0, 20.0],  points: 0, maxPoints: 1, icon: "inv_drink_25_honeytea", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Your spells and abilities have a chance to make your next Spinning Crane Kick deal an additional X% damage. */
"Dance of Chi-Ji": {id: 438439, values: [400.0],  points: 0, maxPoints: 1, icon: "ability_monk_cranekick_new", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Renewing Mist's healing is increased by X% on your lowest health ally with its effect. */
"Mistline": {id: 1280297, values: [500.0],  points: 0, maxPoints: 1, icon: "ability_monk_surgingmist", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
...
"Tear of Morning": {id: 387991, values: [20.0, 8.0, 20.0],  points: 0, maxPoints: 1, icon: "ability_monk_uplift", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

}},

/* Rising Sun Kick extends your Renewing Mist and Enveloping Mist effects by X sec, up to Y% of their original duration. */
"Rising Mist": {id: 274909, values: [4.0, 100.0],  points: 0, maxPoints: 1, icon: "ability_monk_effuse", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: 
number) {
...
talentValues: any, points: number) {
...
"Spiritfont1": {id: 1260511, values: [20.0, 5.0],  points: 0, maxPoints: 4, icon: "inv12_apextalent_monk_spiritfont", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
}},
...
"Spiritfont3": {id: 1260680,  values: [30.0], points: 0, maxPoints: 4, icon: "inv12_apextalent_monk_spiritfont", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
}},
...
const heroTalents: TalentTree = {
    ...
    function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Restore Balance": {id: 442719, values: [0.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_chiexplosion", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Heart of the Jade Serpent": {id: 443294, values: [8000.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_dragonkick", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Chi-Ji's Swiftness": {id: 443566, values: [75.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "inv_shoulder_leather_raidmonkemerald_d_01", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Strength of the Black Ox": {id: 443110, values: [5.0, 5.0, 2.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_chargingoxwave", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Path of the Falling Star": {id: 1273154, values: [100.0, 20.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_chiswirl", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Yu'lon's Avatar": {id: 1262667, values: [4000.0, 100.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "inv_celestialserpentmount_jade", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* Fortifying Brew grants you an absorb shield for $442749s2% of your maximum health. */
    "Niuzao's Protection": {id: 442747, values: [0.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_chargingoxwave", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Jade Sanctuary": {id: 443059, values: [-15.0, 10.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_jadeserpentbreath", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* Strength of the Black Ox's effect is $?c3[X][Y]% more effective on your primary target. */
    "Stampede of the Ancients": {id: 1262756, values: [300.0, 400.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "monk_ability_summonoxstatue", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Inner Compass": {id: 443571, values: [2.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "inv_10_dungeonjewelry_explorer_trinket_1compass_color2", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* Heart of the Jade Serpent increases your haste by $443421s8% while active. */
    "Flowing Wisdom": {id: 1262672, values: [10.0], heroTree: "Conduit of the Celestials", points: 0, maxPoints: 1, icon: "ability_monk_flyingdragonkick", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Aspect of Harmony": {id: 450508, values: [12.0, 10.0, 6.0, 30.0, 0.0, 40.0, 100.0, 8.0, 20.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "inv_ability_masterofharmonymonk_aspectofharmony", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* $?c1[Chi Burst and Chi Wave deal][Chi Wave deals] X% increased damage and healing. */
    "Manifestation": {id: 450875, values: [50.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "inv_shoulder_inv_leather_raidmonk_s_01", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Purified Spirit": {id: 450867, values: [0.0, 4.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_monk_explodingjadeblossom", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Balanced Stratagem": {id: 450889, values: [0.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_monk_sphereharmonydiscord", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Harmonic Surge": {id: 1270958, values: [55.0, 10.0, 10.0, 40.0, 2.0, 2.0, 5.0, 5.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_socererking_forcenova", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* Casting Tiger's Lust reduces the remaining cooldown on Roll by ${X/1000} sec. */
    "Tiger's Vigor": {id: 451041, values: [5000.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "monk_stance_whitetiger", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* Tiger's Lust grants $452701s1% movement speed to up to $452701i allies near its target. */
    "Roar from the Heavens": {id: 451043, values: [0.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "inv_celestialserpentmount", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Mantra of Purity": {id: 451036, values: [10.0, 10.0, 100.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_monk_domeofmist", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* $?a137023[Fortifying Brew applies a Chi Cocoon, absorbing $<value> damage][Fortifying Brew grants X% Stagger]. */
    "Mantra of Tenacity": {id: 451029, values: [20.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "spell_monk_brewmastertraining", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Potential Energy": {id: 1271048, values: [0.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "spell_magic_managain", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Overwhelming Force": {id: 451024, values: [15.0, 5.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_titankeeper_piercingcorruption", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* $?a450391[Chi Wave][Chi Burst] increases vitality stored by $451084s1% for $451084d. */
    "Path of Resurgence": {id: 450912, values: [0.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_monk_pathofmists", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* $?a137023[][Rising Sun Kick, ]Blackout Kick and Tiger Palm contribute X% additional vitality. */
    "Way of a Thousand Strikes": {id: 450965, values: [30.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_monk_mightyoxkick", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {

    }},

    /* Casting $?a137023[Purifying Brew][Enveloping Mist] stores $<value> additional vitality. */
    "Clarity of Purpose": {id: 451017, values: [300.0, 100.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_titankeeper_cleanse", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
    ...
    "Coalescence": {id: 450529, values: [0.0, 100.0, 50.0], heroTree: "Master of Harmony", points: 0, maxPoints: 1, icon: "ability_monk_effuse", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: any, points: number) {
