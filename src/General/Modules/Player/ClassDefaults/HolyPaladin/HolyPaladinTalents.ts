...
const classTalents: TalentTree = {
    ...
    "Armory of Light": {id: 1277443, values: [0.0, 15.0, 20.0, 15.0, 20.0],  points: 0, maxPoints: 1, icon: "inv12_ability_paladin_sentinel", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Armor increased by Z%, Stamina increased by X% and damage taken from area of effect attacks reduced by Y%. */
    "Sanctified Plates": {id: 402964, values: [5.0, -3.0, 10.0],  points: 0, maxPoints: 2, icon: "inv_chest_plate_raidpaladin_s_01", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* $@spelldesc386732 */
    "Divine Resonance": {id: 386738, values: [0.0],  points: 0, maxPoints: 1, icon: "ability_mount_goatmountwhite", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Recompense": {id: 384914, values: [50.0, 25.0, 30.0, 100.0],  points: 0, maxPoints: 1, icon: "ability_racial_foregedinflames", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Holy Power spending abilities have X% increased damage and healing. */
    "Sacred Strength": {id: 469337, values: [2.0],  points: 0, maxPoints: 1, icon: "spell_holy_righteousnessaura", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Divine Purpose": {id: 223817, values: [15.0],  points: 0, maxPoints: 1, icon: "spell_holy_divinepurpose", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* $?s2812[Denounce][Shield of the Righteous] heals you and up to Z nearby allies for $403460s1. */
    "Lightforged Blessing": {id: 406468, values: [0.0, 2.0, 2.0],  points: 0, maxPoints: 1, icon: "spell_holy_circleofrenewal", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Vengeful Wrath": {id: 1241958, values: [50.0],  points: 0, maxPoints: 2, icon: "spell_paladin_hammerofwrath", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Consecration heals you and Y allies within it for $<points> every $26573t1 sec. */
    "Golden Path": {id: 377128, values: [0.0, 5.0],  points: 0, maxPoints: 1, icon: "ability_priest_cascade", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Selfless Healer": {id: 469434, values: [30.0, 40.0],  points: 0, maxPoints: 1, icon: "ability_paladin_gaurdedbythelight", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
        buffSpellPerc(spellDB["Flash of Light"], 10); // There's a Holy mod to the values.
        buffSpellPerc(spellDB["Holy Light"], 10);
    }},
    ...
    "Blessing of Dawn": {id: 183416, values: [5.0, 10.0, 85.0, 30.0, 75.0, 0.0, 5.0],  points: 0, maxPoints: 1, icon: "achievement_zone_valeofeternalblossoms", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* X% of all healing done to you from other sources heals up to Y nearby allies, divided evenly among them. */
    "Lightbearer": {id: 469416, values: [10.0, 4.0],  points: 0, maxPoints: 1, icon: "spell_paladin_clarityofpurpose", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Damage taken reduced by up to X%, increasing as your health decreases. */
    "Blessing of Dusk": {id: 1241945, values: [10.0, 0.0],  points: 0, maxPoints: 1, icon: "achievement_zone_newshadowmoonvalley", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
...
const specTalents: TalentTree = {
    ...
    "Infusion of Light": {id: 53576, values: [10.0],  points: 0, maxPoints: 1, icon: "ability_paladin_infusionoflight", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Beacon of the Lightbringer": {id: 197446, values: [30.0],  points: 0, maxPoints: 1, icon: "spell_paladin_clarityofpurpose", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Protection of Tyr": {id: 200430, values: [10.0],  points: 0, maxPoints: 1, icon: "spell_holy_auramastery", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Consuming Infusion of Light reduces the cooldown of Holy Shock by ${X/-1000}.1 sec. */
    "Imbued Infusions": {id: 392961, values: [-1000.0],  points: 0, maxPoints: 1, icon: "ability_priest_flashoflight", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Saved by the Light": {id: 157047, values: [300.0, 9.0],  points: 0, maxPoints: 1, icon: "ability_paladin_savedbythelight", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Allies with Beacon of Light receive X% less damage. */
    "Light's Protection": {id: 461243, values: [5.0],  points: 0, maxPoints: 1, icon: "spell_holy_absolution", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    talented. */
    "Shining Righteousness": {id: 414443, values: [35.0, 0.0],  points: 0, maxPoints: 1, icon: "spell_holy_holynova", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Crusader's Might": {id: 196926, values: [-1500.0, -1500.0],  points: 0, maxPoints: 1, icon: "ability_paladin_swiftretribution", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Divine Revelations": {id: 387808, values: [500.0, 20.0],  points: 0, maxPoints: 1, icon: "ability_paladin_infusionoflight", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Pillars of Light": {id: 1232616, values: [0.0],  points: 0, maxPoints: 1, icon: "inv_helm_plate_raidpaladindragon_d_01", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Seek Deliverance": {id: 1271016, values: [5.0, 30.0, 5.0],  points: 0, maxPoints: 1, icon: "spell_holy_blessedresillience", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
        ...
        // Needs support for Sanc Wrath but it sucks so TBA.
    }},
    ...
    "Call of the Righteous": {id: 1241511, values: [-30000.0, -5000.0, -30000.0, -3000.0],  points: 0, maxPoints: 2, icon: "ability_paladin_gaurdedbythelight", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Truth Prevails": {id: 461273, values: [-30.0, 50.0, 2.0],  points: 0, maxPoints: 1, icon: "ability_paladin_artofwar", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
        attachSpellEffect(spellDB["Judgment"], spellDB["Truth Prevails"]);
    ...
    "Seraphic Barrier": {id: 1241714, values: [18.0, -15.0],  points: 0, maxPoints: 1, icon: "ability_paladin_protectoroftheinnocent", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Beacon of the Savior1": {id: 1244878, values: [30.0, 10.0, 0.0, 0.0],  points: 0, maxPoints: 4, icon: "inv12_apextalent_paladin_beaconofthesavior", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Beacon of the Savior2": {id: 1245367,  values: [10.0, 10.0], points: 0, maxPoints: 4, icon: "inv12_apextalent_paladin_beaconofthesavior", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Beacon of the Savior3": {id: 1245368,  values: [0.0], points: 0, maxPoints: 4, icon: "inv12_apextalent_paladin_beaconofthesavior", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
...
const heroTalents: TalentTree = {
    ...
    "Dawnlight": {id: 431377, values: [2.0, 8000.0, 20.0, 3.0], heroTree: "Herald of the Sun", points: 0, maxPoints: 1, icon: "inv_ability_heraldofthesunpaladin_dawnlight", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Morning Star": {id: 431482, values: [20.0], heroTree: "Herald of the Sun", points: 0, maxPoints: 1, icon: "spell_holy_persecution", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Lingering Radiance": {id: 431407, values: [6000.0], heroTree: "Herald of the Sun", points: 0, maxPoints: 1, icon: "spell_holy_mindvision", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Aurora": {id: 439760, values: [0.0, 1.0], heroTree: "Herald of the Sun", points: 0, maxPoints: 1, icon: "spell_holy_rune", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Walk Into Light": {id: 1263782, values: [100.0, 2.0, 100.0], heroTree: "Herald of the Sun", points: 0, maxPoints: 1, icon: "ability_paladin_sheathoflight", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Solidarity": {id: 432802, values: [0.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "spell_holy_heroism", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Masterwork": {id: 1271387, values: [3.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_mace_1h_blacksmithing_b_01_black", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Your spells and abilities have a chance to manifest a Holy Armament for a nearby ally. */
    "Divine Inspiration": {id: 432964, values: [0.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "ability_priest_flashoflight", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* The cooldown of Holy Armaments is reduced by X%. */
    "Forewarning": {id: 432804, values: [-20.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "ability_paladin_gaurdedbythelight", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Authoritative Rebuke": {id: 469886, values: [1000.0, 100.0, 1000.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_misc_symbolofkings_01", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Tempered in Battle": {id: 469701, values: [100.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_everburningforge_yellow", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Laying Down Arms": {id: 432866, values: [15000.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "ability_paladin_handoflight", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Hammer and Anvil": {id: 433718, values: [100.0, 100.0, 5.0, 5.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_10_blacksmithing_consumable_repairhammer_color1", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Consuming $?a137028[Shining Light][Infusion of Light] reduces the cooldown of Holy Armaments by ${X/1000}.1 sec. */
    "Valiance": {id: 432919, values: [3000.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_mace_47", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* The effect of your active Aura is increased by $432496s1% on targets with your Armaments. */
    "Shared Resolve": {id: 432821, values: [0.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "spell_holy_devotionaura", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Reflection of Radiance": {id: 1271466, values: [3.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_enchanting_70_pet_torch", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* $?c1[Holy Armaments activate][Divine Toll activates] Hammer and Anvil at X% effectiveness. */
    "Resounding Strike": {id: 1271553, values: [100.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_11_0_arathordungeon_bell_color1", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Blessing of the Forge": {id: 433011, values: [0.0], heroTree: "Lightsmith", points: 0, maxPoints: 1, icon: "inv_ability_lightsmithpaladin_sacredweapon", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
