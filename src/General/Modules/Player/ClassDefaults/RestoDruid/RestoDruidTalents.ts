import { addStatPerc, adjBuffDurationFlat, attachSpellEffect, buffSpellCritChance, buffSpellCritMult, buffSpellPerc, cooldownAdjPerc, manaCostAdj } from "../Generic/TalentBase";

/**
 * A list of talents to turn on
 */
export const defaultTalents = (talents: TalentTree, loadoutName: string, heroTree: string = "Wildstalker") => {
...
const classTalents: TalentTree = {
    ...
    "Grievous Wounds": {id: 474526, values: [10.0, 10.0],  points: 0, maxPoints: 1, icon: "ability_xavius_tormentingswipe", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Stamina increased by X%.    Stamina in Bear Form is increased by an additional Y%. */
    "Ursoc's Spirit": {id: 449182, values: [4.0, 5.0],  points: 0, maxPoints: 1, icon: "spell_nature_spiritarmor", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Frenzied Regeneration and Barkskin increase all healing received by X%. */
    "Verdant Heart": {id: 301768, values: [20.0, 20.0],  points: 0, maxPoints: 1, icon: "ability_bullrush", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], 
    points: number) {
    ...
    "Improved Barkskin": {id: 327993, values: [4000.0],  points: 0, maxPoints: 1, icon: "spell_nature_stoneclawtotem", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Magical damage and healing increased by X%. */
    "Nurturing Instinct": {id: 33873, values: [6.0, 6.0],  points: 0, maxPoints: 2, icon: "ability_druid_healinginstincts", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
        addStatPerc(state.statBonuses, "genericHealingMult", talentValues[0]);
    }},
    ...
    "Primal Fury": {id: 159286, values: [0.0, 20.0],  points: 0, maxPoints: 1, icon: "ability_racial_cannibalize", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Reduces all damage taken by X%. */
    "Thick Hide": {id: 16931, values: [-4.0],  points: 0, maxPoints: 1, icon: "inv_misc_pelt_bear_03", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Healing you receive is increased by X%. */
    "Natural Recovery": {id: 377796, values: [4.0],  points: 0, maxPoints: 1, icon: "ability_druid_naturalperfection", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Increases the range of all of your spells by X yards. */
    "Astral Influence": {id: 197524, values: [5.0, 0.0, 5.0, 5.0, 5.0, 0.0, 0.0, 0.0, 5.0],  points: 0, maxPoints: 1, icon: "ability_skyreach_lens_flare", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Aessina's Renewal": {id: 474678, values: [0.0, 12.0, 30.0],  points: 0, maxPoints: 1, icon: "spell_nature_healingtouch", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Starlight Conduit": {id: 451211, values: [5.0, -4000.0, -50.0],  points: 0, maxPoints: 1, icon: "spell_arcane_arcane01", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Increases your movement speed by X%. */
    "Feline Swiftness": {id: 131768, values: [15.0],  points: 0, maxPoints: 1, icon: "ability_druid_dash", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* When you fall below Y% health, you cast Frenzied Regeneration, up to once every X sec. */
    "Well-Honed Instincts": {id: 377847, values: [120.0, 40.0],  points: 0, maxPoints: 1, icon: "ability_druid_tigersroar", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Oakskin": {id: 449191, values: [-10.0],  points: 0, maxPoints: 1, icon: "spell_nature_stoneclawtotem", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], 
    points: number) {

    }},

    /* Well-Honed Instincts can trigger up to once every ${$382912d+X} sec. */
    "Perfectly-Honed Instincts": {id: 1213597, values: [-30.0],  points: 0, maxPoints: 1, icon: "ability_druid_tigersroar", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Ferocious Bite and Maul damage increased by X%. */
    "Instincts of the Claw": {id: 449184, values: [8.0],  points: 0, maxPoints: 1, icon: "spell_shadow_vampiricaura", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Lycara's Teachings": {id: 378988, values: [3.0],  points: 0, maxPoints: 2, icon: "inv_trinket_ardenweald_02_green", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
        addStatPerc(state.statBonuses, "haste", talentValues[0] * points);
    }},

    /* Moonfire and Sunfire damage increased by X%. */
    "Lore of the Grove": {id: 449185, values: [10.0, 10.0],  points: 0, maxPoints: 1, icon: "spell_nature_starfall", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Ursine Vigor": {id: 377842, values: [15.0],  points: 0, maxPoints: 1, icon: "ability_druid_markofursol", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Cooldown reduced by ${$m1/-1000} sec. */
    "Improved Stampeding Roar": {id: 288826, values: [-60000.0],  points: 0, maxPoints: 1, icon: "spell_druid_stamedingroar", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Physical damage dealt by your abilities increased by $?a137012[Z][X]%. */
    "Circle of the Wild": {id: 474530, values: [5.0, 5.0, 25.0, 25.0],  points: 0, maxPoints: 1, icon: "ability_druid_disembowel", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Magical damage dealt by your spells increased by $?a137012[Z][X]%. */
    "Circle of the Heavens": {id: 474541, values: [5.0, 5.0, 25.0, 25.0],  points: 0, maxPoints: 1, icon: "spell_druid_equinox", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Forestwalk": {id: 400129, values: [8.0],  points: 0, maxPoints: 2, icon: "spell_lifegivingspeed", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Fluid Form": {id: 449193, values: [0.0],  points: 0, maxPoints: 1, icon: "ability_druid_mastershapeshifter", select: true, tier: 0, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
...
const specTalents: TalentTree = {
    ...
    "Omen of Clarity": {id: 113043, values: [4.0],  points: 0, maxPoints: 1, icon: "spell_nature_crystalball", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Verdant Infusion": {id: 392410, values: [8.0],  points: 0, maxPoints: 1, icon: "inv_relics_totemoflife", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Swiftmend now has ${$m1+1} charges. */
    "Prosperity": {id: 200383, values: [1.0],  points: 0, maxPoints: 1, icon: "ability_druid_giftoftheearthmother", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* The healing bonus to Regrowth from Nature's Swiftness is increased by X%. */
    "Nature's Splendor": {id: 392288, values: [35.0],  points: 0, maxPoints: 1, icon: "spell_nature_spiritarmor", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Improved Regrowth": {id: 231032, values: [40.0],  points: 0, maxPoints: 1, icon: "spell_nature_resistnature", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Soul of the Forest": {id: 158478, values: [0.0],  points: 0, maxPoints: 1, icon: "ability_druid_manatree", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Increases Omen of Clarity's chance to activate Clearcasting to Z% and Clearcasting can stack X additional time. */
    "Tranquil Mind": {id: 403521, values: [1.0, 1.0, 5.0],  points: 0, maxPoints: 1, icon: "ability_druid_serenefocus", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Grove Guardians": {id: 1226140, values: [0.0],  points: 0, maxPoints: 1, icon: "ability_druid_forceofnature", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Inner Peace": {id: 197073, values: [-30000.0],  points: 0, maxPoints: 1, icon: "ability_druid_dreamstate", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Tranquility extends the duration of all of your heal over time effects by X sec every $740t1 sec. */
    "Flourish": {id: 197721, values: [2.0],  points: 0, maxPoints: 1, icon: "spell_druid_wildburst", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* When Rejuvenation heals a target below X% health, they are instantly healed for $200389s1. */
    "Cultivation": {id: 200390, values: [60.0],  points: 0, maxPoints: 1, icon: "spell_nature_healingtouch", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Stonebark": {id: 197061, values: [20.0],  points: 0, maxPoints: 1, icon: "archaeology_5_0_crackedmogurunestone", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Ironbark's cooldown is reduced by ${X/-1000} sec. */
    "Improved Ironbark": {id: 382552, values: [-20000.0],  points: 0, maxPoints: 1, icon: "spell_druid_ironbark", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Regenesis": {id: 383191, values: [10.0, 20.0],  points: 0, maxPoints: 2, icon: "inv_misc_herb_liferoot_stem", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Regenerative Heartwood": {id: 392116, values: [75.0, 4000.0],  points: 0, maxPoints: 1, icon: "spell_nature_naturetouchgrow", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Ysera's Gift": {id: 145108, values: [3.0],  points: 0, maxPoints: 1, icon: "inv_misc_head_dragon_green", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Call of the Elder Druid": {id: 426784, values: [15.0],  points: 0, maxPoints: 1, icon: "spell_unused2", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Liveliness": {id: 426702, values: [-25.0, -5.0, -25.0],  points: 0, maxPoints: 1, icon: "spell_druid_symbiosis", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Master Shapeshifter": {id: 289237, values: [30.0, 30.0, 60.0, 5.0, 0.0, 60.0],  points: 0, maxPoints: 1, icon: "ability_druid_mastershapeshifter", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Ysera's Gift now heals every ${Y/1000} sec and its healing is increased by X% for each of your active Rejuvenations. */
    "Waking Dream": {id: 392221, values: [8.0, 4000.0],  points: 0, maxPoints: 1, icon: "inv_misc_head_dragon_green", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Embrace of the Dream": {id: 392124, values: [5.0, 100.0, 100.0],  points: 0, maxPoints: 1, icon: "ability_druid_healinginstincts", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Cenarius' Guidance": {id: 393371, values: [0.0],  points: 0, maxPoints: 1, icon: "ability_druid_treeoflife", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Dream of Cenarius": {id: 158504, values: [100.0, 50.0, 200.0],  points: 0, maxPoints: 1, icon: "ability_druid_dreamstate", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Nurturing Dormancy": {id: 392099, values: [2.0, 6.0],  points: 0, maxPoints: 1, icon: "ability_druid_replenish", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
        const originalDuration = spellDB['Rejuvenation'][0].buffDuration!;
        adjBuffDurationFlat(spellDB['Rejuvenation'], talentValues[1] * points, 1);
        spellDB["Rejuvenation"][0].expectedOverheal += (talentValues[1] / originalDuration * 0.5);
    }},

    /* Your periodic heals on targets with Lifebloom have a Y% chance to cause it to bloom. */
    "Photosynthesis": {id: 274902, values: [0.0, 8.0],  points: 0, maxPoints: 1, icon: "spell_lifegivingseed", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Lifebloom counts for ${X+1} stacks of Mastery: Harmony. */
    "Harmonious Blooming": {id: 392256, values: [2.0],  points: 0, maxPoints: 1, icon: "inv_misc_herb_felblossom", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Every X casts of Swiftmend grants you Incarnation: Tree of Life for Y sec. */
    "Reforestation": {id: 392356, values: [4.0, 10.0],  points: 0, maxPoints: 1, icon: "inv_herbalism_70_yserallineseed", select: true, tier: 1, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
...
const heroTalents: TalentTree = {
    ...
    "Hunt Beneath the Open Skies": {id: 439868, values: [3.0, 3.0, 3.0, 10.0, 10.0], heroTree: "Wildstalker", points: 0, maxPoints: 1, icon: "spell_druid_lunarinspiration", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Strategic Infusion": {id: 439890, values: [4.0, 4.0], heroTree: "Wildstalker", points: 0, maxPoints: 1, icon: "ability_druid_supriseattack", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Green Thumb": {id: 1270565, values: [20.0, 20.0], heroTree: "Wildstalker", points: 0, maxPoints: 1, icon: "spell_lifegivingseed", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Entangling Vortex": {id: 439895, values: [3000.0], heroTree: "Wildstalker", points: 0, maxPoints: 1, icon: "spell_druid_ursolsvortex", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Flower Walk": {id: 439901, values: [10.0], heroTree: "Wildstalker", points: 0, maxPoints: 1, icon: "inv_misc_trailofflowers", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Twin Sprouts": {id: 440117, values: [30.0], heroTree: "Wildstalker", points: 0, maxPoints: 1, icon: "inv_misc_herb_evergreenmoss", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Dream Surge": {id: 433831, values: [3.0, 3.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "inv_ability_keeperofthegrovedruid_dreamsurge_fiendly", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Your $?a137013[Force of Nature treants][Grove Guardians] cast Moonfire on nearby targets about once every X sec. */
    "Treants of the Moon": {id: 428544, values: [6.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "spell_nature_starfall", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Your maximum mana is increased by Y%$?a137013[ and your maximum Astral Power is increased by ${X/10}][]. */
    "Expansiveness": {id: 429399, values: [200.0, 5.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "spell_nature_abolishmagic", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* Your Regrowth protects you, reducing damage you take by X% while your Regrowth is on you. */
    "Protective Growth": {id: 433748, values: [8.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "spell_nature_resistnature", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Power of Nature": {id: 428859, values: [0.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "spell_nature_naturesblessing", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Cenarius' Might": {id: 455797, values: [0.0, 20.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "achievement_reputation_guardiansofcenarius", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Grove's Inspiration": {id: 429402, values: [10.0, 9.0, 9.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "ability_druid_protectionofthegrove", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Dryad's Dance": {id: 1264776, values: [25.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "inv_stave_2h_druid_a_01", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Early Spring": {id: 428937, values: [-15000.0, -1000.0, -1000.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "inv_misc_trailofflowers", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {

    }},

    /* $?a137013[Force of Nature grants an additional stack of Dream Burst.][Dream Surge heals Y additional $Lally:allies;.] */
    "Power of the Dream": {id: 434220, values: [1.0, 1.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "ability_xavius_dreamsimulacrum", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Control of the Dream": {id: 434249, values: [15.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "inv_cloth_outdooremeralddream_d_01_buckle", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Blooming Infusion": {id: 429433, values: [5.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "spell_nature_thorns", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
    ...
    "Harmony of the Grove": {id: 428731, values: [0.0], heroTree: "Keeper of the Grove", points: 0, maxPoints: 1, icon: "ability_druid_forceofnature", select: true, tier: 2, runFunc: function (state: any, spellDB: SpellDB, talentValues: number[], points: number) {
