      ...
      {resultValid ? (
        <Grid container spacing={1}>
          ...
          /* ----------------------------------------------------------------------------------------------  */}
           ...
           <Grid item xs={12}>{(advice && advice.length > 0) ? <ListedInformationBox introText="Here are some notes on your set:" bulletPoints={advice} color="green" title="Insights - Set Notes" /> : ""}</Grid>                     
