      ...
      {resultValid ? (
        <Grid container spacing={1}>
          ...
          /* ----------------------------------------------------------------------------------------------  */}
           ...
           <Grid item xs={12}>{(advice && advice.length > 0) ? <ListedInformationBox introText="The above set of gear is your best, but here are some notes on your set:" bulletPoints={advice} title="Insights" /> : ""}</Grid>                     
