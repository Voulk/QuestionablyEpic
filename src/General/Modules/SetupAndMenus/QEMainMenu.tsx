...
export default function QEMainMenu(props: Props) {
  ...
  const mainMenuOptions: MainMenuOption[] =
    gameType === "Retail"
      ? [
          // Gearing
          { route: "/topgear", disabled: !(["Holy Priest", "Restoration Druid", "Holy Paladin", "Preservation Evoker", "Restoration Shaman", "Mistweaver Monk"].includes(props.player.spec)), tooltip: "TopGear", type: "Gearing", order: 0, localization: "MainMenu.TopGear", glow: true },
          { route: "/upgradeFinder", disabled: !(["Holy Priest", "Restoration Druid", "Holy Paladin", "Preservation Evoker", "Restoration Shaman", "Mistweaver Monk"].includes(props.player.spec)), tooltip: "UpgradeFinder", type: "Gearing", order: 1, localization: "MainMenu.UpgradeFinder", glow: false },
