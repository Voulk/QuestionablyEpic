...
import OmniumFolioChart from "./OmniumFolioChart";
...
export default function OmniumFolioAnalysis(props) {
  useEffect(() => {
          ...
          <Grid container spacing={1} justify="center">
            <Grid item xs={12}>
              <Paper style={{ backgroundColor: "rgb(28, 28, 28, 0.5)" }} elevation={1} variant="outlined">
                {<OmniumFolioChart data={activeCombos} db={activeCombos} itemLevels={itemLevels} theme={themeSelection(theme ? "candidate2" : "candidate7")} />}
              </Paper>
