export const bossAbilities = [
  ...
  {
    bossID: 2432,
    ability: "Lingering Malevolence",
    guid: 350489,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/RemnantOfNerzhul/Icons/spell_shadow_deathsembrace.jpg").default,
  },
  {
    bossID: 2432,
    ability: "Spite",
  ...
  },
  {
    ...
    guid: 349890,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/RemnantOfNerzhul/Icons/spell_mage_infernoblast.jpg").default,
  },
  {
    bossID: 2432,
    ability: "Grasp of Malice",
    guid: 350076,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/RemnantOfNerzhul/Icons/ability_bossdarkvindicator_auraofmalice.jpg").default,
  },
  ...
  {
    bossID: 2434,
    ability: "Agonizing Spike",
    guid: 351787,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/SoulrenderDormazain/Icons/spell_animamaw_missile.jpg").default,
  },
  {
    bossID: 2434,
    ability: "Torment",
  ...
  {
    bossID: 2434,
    ability: "Rendered Soul",
    guid: 351229,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/SoulrenderDormazain/Icons/ability_demonhunter_shatteredsouls.jpg").default,
  },
  {
    bossID: 2434,
    ability: "Warmonger Shackle",
    guid: 350927,
    cooldownPlannerActive: true,
    icon: require("Images/Bosses/SanctumOfDomination/SoulrenderDormazain/Icons/ability_deathknight_deathchain.jpg").default,
  },
  {
    bossID: 2434,
    ability: "Vessel of Torment",
    guid: 350851,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/SoulrenderDormazain/Icons/inv_axe_2h_artifactmaw_d_05.jpg").default,
  },
  {
    bossID: 2434,
    ability: "Ruinblade",
    guid: 350422,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/SoulrenderDormazain/Icons/inv_sword_1h_artifactruneblade_d_02.jpg").default,
  },
  ...
  {
    bossID: 2430,
    ability: "Shadowsteel Chains",
    guid: 355506,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/PainsmithRaznal/Icons/ability_deathknight_deathchain.jpg").default,
  },
  {
    bossID: 2430,
    ability: "Flameclasp Detonation",
    guid: 348463,
    cooldownPlannerActive: true,
  ...
  {
    bossID: 2430,
    ability: "Shadowsteel Embers",
    guid: 355535,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/PainsmithRaznal/Icons/ability_warlock_burningembers.jpg").default,
  },
  {
    bossID: 2430,
    ability: "Blackened Armor",
    guid: 355786,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/PainsmithRaznal/Icons/inv_shoulder_mail_raidshaman_j_01.jpg").default,
  },
  {
    bossID: 2430,
    ability: "Dualblade Scythe",
    guid: 355788,
    cooldownPlannerActive: true,
  ...
  },
  {
    ...
    guid: 348255,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/PainsmithRaznal/Icons/ability_fomor_boss_pillar02.jpg").default,
  },
  {
    bossID: 2430,
  ...
  },
  {
    ...
    guid: 348363,
    cooldownPlannerActive: false,
    icon: require("Images/Bosses/SanctumOfDomination/PainsmithRaznal/Icons/ability_warrior_trauma.jpg").default,
  },
  ...
  /* ---------------------------------------------------------------------------------------------- */
  {
    // https://ptr.wowhead.com/spell=346459/glacial-wrath
    bossID: 2422,
    ability: "Glacial Wrath",
    guid: 346459,
    cooldownPlannerActive: true,
    icon: require("Images/Bosses/SanctumOfDomination/Kelthuzad/Icons/ability_deathknight_pillaroffrost.jpg").default,
  },
  {
    // https://ptr.wowhead.com/spell=348756/frost-blast
    bossID: 2422,
    ability: "Frost Blast",
    guid: 348756,
    cooldownPlannerActive: true,
  ...
  {
    // https://ptr.wowhead.com/spell=354289/sinister-miasma
    bossID: 2422,
    ability: "Sinister Miasma",
    guid: 354289,
    cooldownPlannerActive: true,
  ...
  {
    // https://ptr.wowhead.com/spell=347704/veil-of-darkness
    bossID: 2435,
    ability: "Veil of Darkness",
    guid: 347704,
    cooldownPlannerActive: true,
    icon: require("Images/Bosses/SanctumOfDomination/SylvanusWindrunner/Icons/ability_argus_deathfog.jpg").default,
  },
  {
    // https://ptr.wowhead.com/spell=347670/shadow-dagger
    bossID: 2435,
  ...
  {
    // https://ptr.wowhead.com/spell=352650/rangers-heartseeker
    bossID: 2435,
  ...
  {
    // https://ptr.wowhead.com/spell=351252/banshee-wail
    bossID: 2435,
