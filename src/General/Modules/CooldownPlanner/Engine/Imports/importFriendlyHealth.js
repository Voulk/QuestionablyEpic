...
export default async function importFriendlyHealth(starttime, endtime, reportid) {
  ...
  await axios
    .get(APIdamagetaken + reportid + START + starttime + END + endtime + HOSTILITY + resourceType + sourceClass + translate + API2)
    .then((result) => {
      health = result.data;
