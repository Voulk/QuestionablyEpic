...
const getMenuItems = (item: any): MenuItemType[] => {
  ...
  const fullItemLevels = [567, 580, 584, 587, 590, 593, 597, 600, 603, 606, 610, 613, 616, 619, 623, 626, 629, 632, 636, 639, 642, 645, 649, 652, 655, 658];
  const itemLevelCaps: { [key: string]: number } = { Explorer: 580, Adventurer: 593, Veteran: 606, Champion: 619, Hero: 626, Myth: 639, Circlet: 658 };
