...
const getMenuItems = (item: any): MenuItemType[] => {
  ...
  const fullItemLevels = [567, 580, 584, 587, 590, 593, 597, 600, 603, 606, 610, 613, 616, 619, 623, 626, 629, 632, 636, 639, 642, 645, 649, 652, 655, 658, 662, 665, 668, 671, 675, 678, 681, 684 ];
  const itemLevelCaps: { [key: string]: number } = { Explorer: 619, Adventurer: 632, Veteran: 645, Champion: 658, Hero: 671, Myth: 684, Circlet: 658 };
