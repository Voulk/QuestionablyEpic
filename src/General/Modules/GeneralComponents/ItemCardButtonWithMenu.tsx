...
const getMenuItems = (item: any): MenuItemType[] => {
  ...
  const itemLevelCaps: { [key: string]: number } = { Explorer: 110, Adventurer: 110, Veteran: 120, Champion: 140, Hero: 157, Myth: 170, Circlet: 155, "Runed Crafted": 154, "Gilded Crafted": 167 };
