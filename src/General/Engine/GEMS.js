export const GEMS = [
  ...
  // Phase 1
  // https://tbc.wowhead.com/item=30594/effulgent-chrysoprase
  // +5 Defense Rating and 2 mana per 5 sec.
  // { name: "Effulgent Chrysoprase", color: "green", rarity: "epic", jewelcrafting: false, stats: { defense: 5, mp5: 2 } },

  /* ------------------------------------ Sundered Chrysoprase ------------------------------------ */
  // Phase 1
  // https://tbc.wowhead.com/item=30550/sundered-chrysoprase
  // +5 Critical Strike Rating and +2 mana per 5 sec.
  //{ name: "Sundered Chrysoprase", color: "green", rarity: "epic", jewelcrafting: false, stats: { meleeCrit: 5, mp5: 2 } },

  /* -------------------------------------- Forceful Talasite ------------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=35318/forceful-talasite
  // +4 Spell Haste Rating and +6 Stamina
  //{ name: "Forceful Talasite", color: "green", rarity: "rare", jewelcrafting: false, stats: { haste: 4, stamina: 6 } },

  /* ---------------------------------- Forceful Seaspray Emerald --------------------------------- */
  // Phase 3
  // https://tbc.wowhead.com/item=35759/forceful-seaspray-emerald
  // +5 Spell Haste Rating and +7 Stamina
  //{ name: "Forceful Seaspray Emerald", color: "green", rarity: "epic", jewelcrafting: false, stats: { haste: 5, stamina: 7 } },
  ...
  /* -------------------------------------- Radiant Talasite -------------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=24066/radiant-talasite
  // +4 Spell Critical Rating and +5 Spell Penetration
  // { name: "Radiant Talasite", color: "green", rarity: "rare", jewelcrafting: false, stats: { crit: 4, spellpenetration: 5 } },

  /* ------------------------------------- Radiant Chrysoprase ------------------------------------ */
  // Phase 1
  // https://tbc.wowhead.com/item=30608/radiant-chrysoprase
  // +5 Spell Critical Rating and +5 Spell Penetration
  // { name: "Radiant Chrysoprase", color: "green", rarity: "epic", jewelcrafting: false, stats: { crit: 5, spellpenetration: 5 } },

  /* ---------------------------------- Radiant Seaspray Emerald ---------------------------------- */
  // Phase 3
  // https://tbc.wowhead.com/item=32224/radiant-seaspray-emerald
  // +5 Spell Critical Rating and +6 Spell Penetration
  // { name: "Radiant Seaspray Emerald", color: "green", rarity: "epic", jewelcrafting: false, stats: { crit: 5, spellpenetration: 6 } },

  /* ------------------------------------ Notched Deep Peridot ------------------------------------ */
  // Phase 1
  // https://tbc.wowhead.com/item=27785/notched-deep-peridot
  // +3 Stamina, +4 Spell Critical Strike Rating
  // { name: "Notched Deep Peridot", color: "green", rarity: "rare", jewelcrafting: false, stats: { stamina: 3, crit: 4 } },

  /* ------------------------------------ Polished Chrysoprase ------------------------------------ */
  // Phase 1
  // https://tbc.wowhead.com/item=30548/polished-chrysoprase
  // +6 Stamina and +5 Spell Crit Rating
  // { name: "Polished Chrysoprase", color: "green", rarity: "epic", jewelcrafting: false, stats: { stamina: 6, crit: 5 } },
  ...
  { name: "Timeless Chrysoprase", color: "green", rarity: "epic", jewelcrafting: false, stats: { intellect: 5, stamina: 6 } },

  /* ------------------------------------- Seer's Chrysoprase ------------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=30586/seers-chrysoprase
  // +4 Intellect and +5 Spirit
  { name: "Seer's Chrysoprase", id: 30586, color: "green", rarity: "epic", jewelcrafting: false, stats: { intellect: 4, spirit: 5 } },

  /* ------------------------------------- Lambent Chrysoprase ------------------------------------ */
  // Phase 1
  // https://tbc.wowhead.com/item=30606/lambent-chrysoprase
  // +5 Spell Hit Rating and 2 mana per 5 sec.
  // { name: "Lambent Chrysoprase", color: "green", rarity: "epic", jewelcrafting: false, stats: { hit: 4, mp5: 2 } },

  /* ---------------------------------- Rune Covered Chrysoprase ---------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=30560/rune-covered-chrysoprase
  // +5 Spell Critical Rating and 2 mana per 5 sec.
  ...
  /* -------------------------------------- Blessed Tanzanite ------------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=30552/blessed-tanzanite
  // +11 Healing +4 Spell Damage and +6 Stamina
  // { name: "Blessed Tanzanite", id: 30552, color: "purple", rarity: "epic", jewelcrafting: false, stats: { bonushealing: 11, stamina: 6 } },

  /* -------------------------------------- Soothing Amethyst ------------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=31117/soothing-amethyst
  // +11 Healing +4 Spell Damage and +6 Stamina
  // { name: "Soothing Amethyst", id: 31117, color: "purple", rarity: "epic", jewelcrafting: false, stats: { bonushealing: 11, stamina: 6 } },
  ...
  /* -------------------------------------- Unstable Sapphire ------------------------------------- */
  // Phase ?
  // https://tbc.wowhead.com/item=32636/unstable-sapphire
  // +9 Healing +3 Spell Damage and +4 Spirit
  //{ name: "Unstable Sapphire", color: "purple", rarity: "rare", jewelcrafting: false, stats: { bonushealing: 9, spirit: 4 } },
  ...
  { name: "Purified Shadowsong Amethyst", id: 37503, color: "purple", rarity: "epic", jewelcrafting: false, stats: { bonushealing: 11, spirit: 5 } },
  ...
  // Phase 1
  // https://tbc.wowhead.com/item=25901/insightful-earthstorm-diamond
  // +12 Intellect & Chance to restore mana on spellcast
  { name: "Insightful Earthstorm Diamond", id: 25901, color: "meta", rarity: "rare", jewelcrafting: false, stats: { intellect: 12 }, requirements: "At least 2 red, 2 blue, 2 red gems" },

  /* ---------------------------------- Mystical Skyfire Diamond ---------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=25893/mystical-skyfire-diamond
  // Chance to Increase Spell Cast Speed
  { name: "Mystical Skyfire Diamond", color: "meta", rarity: "rare", jewelcrafting: false, stats: {}, requirements: "Requires more blue gems than yellow" },
  ...
  // Phase 5
  // https://tbc.wowhead.com/item=35503/ember-skyfire-diamond
  // +14 Spell Damage & +2% Intellect
  { name: "Ember Skyfire Diamond", color: "meta", rarity: "rare", jewelcrafting: false, stats: {}, requirements: "Atleast 3 red gems" },
  ...
  // Phase 1
  // https://tbc.wowhead.com/item=25890/destructive-skyfire-diamond
  // +14 Spell Crit Rating and 1% Spell Reflect
  { name: "Destructive Skyfire Diamond", color: "meta", rarity: "rare", jewelcrafting: false, stats: { crit: 14 }, requirements: "At least 2 red, 2 blue, 2 red gems" },

  /* ----------------------------------- Chaotic Skyfire Diamond ---------------------------------- */
  // Phase 1
  // https://tbc.wowhead.com/item=34220/chaotic-skyfire-diamond
  // +12 Spell Critical & 3% Increased Critical Damage
  { name: "Chaotic Skyfire Diamond", color: "meta", rarity: "rare", jewelcrafting: false, stats: { crit: 12 }, requirements: "At least 2 blue gems" },
];
