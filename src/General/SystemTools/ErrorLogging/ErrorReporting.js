import { apiSendError } from "../../Modules/SetupAndMenus/ConnectionUtilities";
...
export function reportError(player, type, message, result = "") {
  if (process.env.NODE_ENV === "production") {
    apiSendError(player, type, message, result);
  } else {
